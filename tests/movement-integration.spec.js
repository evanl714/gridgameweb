...
test.describe('Movement System Integration', () => {
  ...
  test.describe('Movement Range Display', () => {
    test('should show movement range when unit is selected', async ({
      page,
    }) => {
    ...
    test('should hide movement range when unit is deselected', async ({
      page,
    }) => {
  ...
  test.describe('Mouse Interaction', () => {
    ...
    test('should handle rapid mouse movements without errors', async ({
      page,
    }) => {
      const canvas = page.locator('#gameCanvas');
      const errors = [];
  ...
  test.describe('Unit Movement Validation', () => {
    ...
    test('should show appropriate feedback for invalid moves', async ({
      page,
    }) => {
  ...
  test.describe('Performance and Memory', () => {
    test('should handle rapid clicking without memory leaks', async ({
      page,
    }) => {
      const canvas = page.locator('#gameCanvas');
  ...
  test.describe('Game State Consistency', () => {
    test('should maintain consistent state after UI interactions', async ({
      page,
    }) => {
    ...
    test('should handle browser resize without breaking movement', async ({
      page,
    }) => {
      const canvas = page.locator('#gameCanvas');
  ...
  test.describe('Turn Integration', () => {
    test('should disable movement during inappropriate phases', async ({
      page,
    }) => {
      const canvas = page.locator('#gameCanvas');
      const gameStatus = page.locator('#gameStatus');
  ...
  test.describe('Error Recovery', () => {
    test('should recover from JavaScript errors gracefully', async ({
      page,
    }) => {
      const errors = [];
